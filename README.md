...
python analysis/coca_vs_reference.py       # §3.1  -> n=206, r=0.957, zero-CAC 52.4% vs 42.7% (reference)
...
| `analysis/coca_vs_reference.py` | §3.1 | COCA non-gated AI-vs-expert correlation + zero-CAC rates |
